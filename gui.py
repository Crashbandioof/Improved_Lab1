...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.radioButton_Jane.setGeometry(QtCore.QRect(220, 80, 62, 14))
        self.radioButton_Jane.setObjectName("radioButton_Jane")
        self.label_voting_results = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_voting_results.setGeometry(QtCore.QRect(40, 170, 211, 16))
        ...
        self.pushButton_vote_candidate.setGeometry(QtCore.QRect(60, 190, 181, 20))
        ...
        self.label_error_message.setGeometry(QtCore.QRect(40, 140, 181, 16))
        ...
        self.lineEdit_input_ID.setObjectName("lineEdit_input_ID")
